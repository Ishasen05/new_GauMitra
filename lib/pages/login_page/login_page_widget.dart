  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      await UsersRecord.collection.doc(user.uid).update(createUsersRecordData(
            ...
            password: int.tryParse(_model.passwordTextController.text),
          ));

      context.pushNamedAuth(LoggedinPageWidget.routeName, context.mounted);
    });
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: Autocomplete<String>(
                      ...
                      optionsViewBuilder: (context, onSelected, options) {
                        return AutocompleteOptionsList(
                          textFieldKey: _model.confirmPasswordKey,
                      ...
                      onSelected: (String selection) {
                        safeSetState(() =>
                            _model.confirmPasswordSelectedOption = selection);
                        FocusScope.of(context).unfocus();
                      },
                      fieldViewBuilder: (
                        context,
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      context.pushNamed(LoginPage1Widget.routeName);
                    },
                    text: 'Login',
                    options: FFButtonOptions(
                      height: 40.0,
