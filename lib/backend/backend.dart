...
import 'schema/cow_details_record.dart';
...
export 'schema/cow_details_record.dart';
...
/// Functions to query CowDetailsRecords (as a Stream and as a Future).
Future<int> queryCowDetailsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CowDetailsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CowDetailsRecord>> queryCowDetailsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CowDetailsRecord.collection,
      CowDetailsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CowDetailsRecord>> queryCowDetailsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
